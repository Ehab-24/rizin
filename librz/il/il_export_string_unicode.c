...
#define UCD_ITE          "↠"
#define UCD_LET          "="
#define UCD_BOOL_FALSE   "𝔽"
#define UCD_BOOL_TRUE    "𝕋"
#define UCD_BOOL_INV     "!"
#define UCD_BOOL_AND     "&"
#define UCD_BOOL_OR      "|"
#define UCD_BOOL_XOR     "^"
...
#define UCD_FCAST_FLOAT  "ꜰꜰ≈"
#define UCD_FCAST_SFLOAT "ꜰꜰ≈⁺"
#define UCD_FCONVERT     "≈"
#define UCD_FSQRT        "²√"
#define UCD_FRSQRT       "¹/√"
#define UCD_FROUND       "⭂"
...
static void il_opdmp_is_zero(const RzILOpPure *op, RzStrBuf *sb) {
	il_op_param_1(UCD_IS_ZERO, op->op.lsb, pure, bv);
}
